  ...
  return (
   <aside  className="md:block hidden bg-cyan-950 w-64 h-screen fixed rounded-none border-none">
      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <Link to="/admin/reservas" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <div className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                  <AiFillContacts />
               </div>
         ...
         <li>
            <Link to="/admin/bitacora" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               <div className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                  <AiFillIdcard />
               </div>
               <span className="ml-3">Bitacora</span>
            </Link>
         </li>
      </ul>
      </div>
